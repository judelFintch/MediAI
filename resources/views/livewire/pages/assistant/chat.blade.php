<div class="flex h-screen bg-gray-50">
    ...
    <div class="flex-1 flex flex-col">
        <!-- Barre supérieure (menu hamburger sur mobile) -->
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-100">
            ...
            <div class="flex justify-end">
                <div class="max-w-full lg:max-w-lg bg-blue-500 text-white p-4 rounded-lg shadow">
            ...
            <div class="flex justify-start">
                <div class="max-w-full lg:max-w-lg bg-white text-gray-800 p-4 rounded-lg shadow border border-gray-300">
            ...
            @if ($conversationHistory && count($conversationHistory) > 0)
                @foreach ($conversationHistory as $message)
                    <div class="{{ $message['role'] === 'user' ? 'flex justify-end' : 'flex justify-start' }}">
                        <div
                            class="max-w-full lg:max-w-lg {{ $message['role'] === 'user' ? 'bg-blue-500 text-white' : 'bg-white text-gray-800 border border-gray-300' }} p-4 rounded-lg shadow">
                            {{ $message['content'] }}
                        </div>
                    </div>
                @endforeach
